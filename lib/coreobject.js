    ...
    for(var p in overrides) {
        ...
        (function(fnc, spr) {
            obj[p] = function () {
                ...
                [].unshift.call(arguments, spr.bind(this));
...
var CoreObject = {
    ...
    extend: function(mixin_in, mixin_static) {
            ...
            if (obj.mixins) {
                for( var p in obj.mixins) {
                    if (obj.mixins.hasOwnProperty(p)) {
                        ...
                        if (m.init)
                        {
                            if (!m.className || m.className != obj.className) {
                                m.init.call(obj, mixin);
                            }
                        }
                    }
                }
        ...
        //realClass.prototype.constructor = realClass;
        realClass.prototype.classType = realClass;
        return realClass;
    }
};
